...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="dashboard.php" class="logo" style="font-family: polo;"><b><i class="fas fa-chalkboard-teacher" style="color: darkturquoise; font-size: 25px;"></i></b>OnineEduca<br>   Dasgboard</a>
